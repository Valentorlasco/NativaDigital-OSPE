...
from tool import create_retriever_tool_from_vectorstore, create_get_medico_tool
...
try:
    ...
    tools = [create_retriever_tool_from_vectorstore(vectorstore), create_get_medico_tool()]
